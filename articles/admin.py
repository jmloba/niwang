...
class UserAccessAdmin(admin.ModelAdmin) : 
  list_display=('user','article_create','article_delete','programmer_access','todo_access_all','todo_rights',)

  list_editable =('article_create','article_delete','programmer_access','todo_access_all','todo_rights',)
  ordering=('user',)
